...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 petal-bg relative">
      <div
        className="absolute top-20 left-10 text-6xl float-anim"
        style={{ color: "rgba(212,118,10,0.18)" }}
      >
        ✦
      </div>
      <div
        className="absolute bottom-20 right-12 text-5xl float-anim"
        style={{ animationDelay: "2s", color: "rgba(26,122,109,0.15)" }}
      >
        ☽
      </div>
      <div
        className="absolute top-1/3 right-8 text-4xl float-anim"
        style={{ animationDelay: "4s", color: "rgba(212,118,10,0.12)" }}
      >
        ✦
      </div>
        ...
        <div className="fancy-border panel-soft rounded-3xl p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <div
              ...
              style={{ color: "rgba(212,118,10,0.28)" }}
            >
              ✦ ☽ ✦
            </div>
            <h1
              className="font-playfair text-3xl italic font-semibold"
              style={{ color: "#2D1810" }}
            >
              Welcome Back
            </h1>
            <p
              className="text-xs font-dm mt-1 tracking-wide"
              style={{ color: "#6B4A3A" }}
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label
                className="font-dm text-[10px] tracking-widest uppercase font-bold block mb-2"
                style={{ color: "#D4760A" }}
              >
                Email
              </label>
          ...
          <p
            className="text-center text-xs font-dm mt-6"
            style={{ color: "#6B4A3A" }}
          >
